 ...
 *
 * This is the core of RedRoomDigital — where users build their characters.
 * The form captures everything the AI needs to roleplay as this character:
 * - Basic info (name, description)
 * - Personality traits, values, and flaws
...
export default function CreateCharacterPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <Link href="/profile" className="text-sm text-slate-400 hover:text-slate-300 mb-2 inline-block">
          ← Back to Profile
        </Link>
        <h1 className="text-3xl font-bold text-white">Create Character</h1>
        <p className="text-slate-400 mt-1">
          Build a character with personality, history, and depth. The AI will use everything you provide.
        </p>
      </div>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="A short description others will see when browsing characters. Who is this character at a glance?"
                rows={3}
          ...
          <div className="space-y-5">
            <div>
              ...
              <textarea
                ...
                placeholder="Tell the character's story. Where did they come from? What shaped them? What are they seeking? The AI will reference this in conversations..."
                rows={6}
                className="w-full px-4 py-2.5 bg-slate-800 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 resize-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. thunderstorms, old books, sparring, strong ale, stargazing"
                className="w-full px-4 py-2.5 bg-slate-800 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500"
              />
            </div>
